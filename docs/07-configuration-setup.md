...
6. Avoid direct configuration editing unless you are validating it deliberately.
   ...
   For Milestone 1, the guide does not instruct you to open or edit config files directly because this repository does not yet contain validated file-edit steps that are safe across multiple environments.
