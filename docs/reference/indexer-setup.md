...
Understand what an indexer does in CKB development, when you need one, and how to decide between local and hosted indexer access within the repository's beginner onboarding scope.
