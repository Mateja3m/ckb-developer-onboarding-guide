...
Document the beginner-facing onboarding failures that are most likely to appear in this repository's CKB flow, using validated observations where possible and clearly labeled interpretation where exact commands are not yet validated here.
